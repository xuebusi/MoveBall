    ...
    execute: function () {
      ...
      _export("MoveBall", MoveBall = (_dec = ccclass('MoveBall'), _dec2 = property(Node), _dec3 = property(Vec2), _dec(_class = (_class2 = class MoveBall extends Component {
        ...
        update(deltaTime) {
          ...
          let hw = this.node.getComponent(UITransform).height; // 小球的半径
          ...
          if (this.ball.position.y >= top || this.ball.position.y <= bottom) {
...
//# sourceMappingURL=c37fd47979209ad5279afa4fd2312953c30c24a1.js.map