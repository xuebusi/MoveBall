  ...
  return {
    ...
    execute: function () {
      ...
      _export("MoveBall", MoveBall = (_dec = ccclass('MoveBall'), _dec(_class = class MoveBall extends Component {
        ...
        update(deltaTime) {
          //console.log("update...");
          this.node.children[0].setPosition(new Vec3(this.node.position.x + 1, this.node.position.y + 1));
        }
...
//# sourceMappingURL=1cee177ec1164089e9b49a6577a86c3b2b453064.js.map